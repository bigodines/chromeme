...
require_once( dirname(__FILE__)."/YahooYQLQuery.class.php" );
...
class PostRepository {
    ...
    public function reposts( $guid, $pubid ) {
        return $this->_yql_query('SELECT * FROM meme.posts.info WHERE owner_guid="'.$guid.'" AND pubid = "'.$pubid.'"'); 
    }
}
...
class Post extends PostRepository {
    ...
    public function reposts() { 
         return parent::reposts( $this->guid, $this->pubid );
    } 
}
?>
